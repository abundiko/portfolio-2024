    ...
    <div className="grid md:grid-cols-3 border border-gray-200">
      ...
      <div className=" md:col-span-2 md:border-l border-gray-200 grid grid-cols-3 lg:grid-cols-4">
        {TECHNOLOGIES.map((tech, i) => (
          <div
            key={i}
            className="flex justify-center items-center flex-col gap-1 border border-gray-200 aspect-[7/6]"
          >
            <Image
              width={200}
              height={200}
              ...
              alt={tech.title}
              loading="lazy"
              className="object-fit w-10/12 aspect-square max-w-20 grayscale"
            />
