...
export default function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className="shadow-[0_0_30px_1px_#00000011] border gap-4 md:gap-6 border-neutral-200 bg-white text-black p-4 md:p-6 rounded-3xl"
    >
      <div className=" grid md:grid-cols-2 bg-red-300">
        <Image
